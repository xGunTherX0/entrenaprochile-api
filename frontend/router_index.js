import { createRouter, createWebHistory } from "/node_modules/.vite/deps/vue-router.js?v=1365c5df"
import Login from "/src/components/Login.vue"
import EntrenadorDashboard from "/src/views/EntrenadorDashboard.vue"
import EntrenadorAprobar from "/src/views/EntrenadorAprobar.vue"
import ClienteRutina from "/src/views/ClienteRutina.vue"
import Home from "/src/views/Home.vue"
import Admin from "/src/views/Admin.vue"
// Admin child panels
import AdminUsuarios from "/src/views/admin/Usuarios.vue"
import AdminMetricas from "/src/views/admin/Metricas.vue"
...
const routes = [
...

  {
    path: '/cliente',
    name: 'Cliente',
    component: () => import("/src/views/ClienteLayout.vue"),
    redirect: '/cliente/mediciones',
    children: [
      { path: 'mediciones', name: 'ClienteMediciones', component: () => import("/src/views/ClienteMediciones.vue") },
      { path: 'explorar', name: 'ClienteExplorar', component: () => import("/src/views/ExplorarRutinas.vue") },
  { path: 'explorar-planes', name: 'ClienteExplorarPlanes', component: () => import("/src/views/ExplorarPlanes.vue") },
      { path: 'misrutinas', name: 'ClienteMisRutinas', component: () => import("/src/views/MisRutinas.vue") },
      { path: 'rutina/:id', name: 'ClienteRutina', component: () => import("/src/views/ClienteRutina.vue"), props: true },
      { path: 'plan/:id', name: 'ClientePlan', component: () => import("/src/views/ClientePlan.vue"), props: true },
      { path: 'planes', name: 'ClientePlanes', component: () => import("/src/views/MisPlanes.vue") },
      // Entrenadores dentro del layout de Cliente para que el panel lateral siempre se muestre
      { path: 'entrenadores', name: 'ClienteExplorarEntrenadores', component: () => import("/src/views/ExplorarEntrenadores.vue") },
      ...
      { path: 'entrenadores/:id', name: 'EntrenadorPublico', component: () => import("/src/views/EntrenadorPublico.vue"), props: true }
    ]
  },
...

  {
    ...
    children: [
      ...
      { path: 'review', name: 'AdminReview', component: () => import("/src/views/admin/AdminReview.vue") },
      { path: 'entrenadores', name: 'AdminTrainers', component: () => import("/src/views/admin/AdminTrainers.vue") },
      { path: 'aceptados', redirect: 'review' },
      { path: 'usuarios/:id', name: 'AdminUsuarioPerfil', component: () => import("/src/views/admin/UsuarioPerfil.vue"), props: true },
